							...
							<div class="content col-md-14">
								<table>
									<div class="write_table"
										...
										<!-- 파일첨부 -->
										<label class="control-label col-sm-2">사진을 드래그 해주세요</label>
										<div id="fileDrop">
							...
							<div class="form-group">
								<div class="col-sm-offset-13 col-sm-13">
									<input type="submit" class="btn_write"
										style="position: relative; border-radius: 12px; background: white; width: 14%; font-size: 18px; border: 2px solid #FEB7D1; padding: 3px; font-weight: 600; color: black;"
										value="등록"> &nbsp;
