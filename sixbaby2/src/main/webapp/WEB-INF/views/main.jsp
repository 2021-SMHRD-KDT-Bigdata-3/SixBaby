...
<body>
	...
	<div class="site-content">
		...
		<div class="slide"
			...
			<ul>
				<li><img class="main_bn"
					src="${cpath}/resources/images/solution.jpg"></li>
				<li><img class="main_bn"
					src="${cpath}/resources/images/crys.jpg"></li>
			</ul>
		</div>
				...
				<div class="row">
					...
					<div class="content col-md-15">
						<div class="main_block">
							<div class="sub_block">
								<br>
								<img class="main_content_img"
									src="${cpath}/resources/images/mike.png"><br>실시간 음성
								인식 서비스
							</div>
						</div>
						<div class="main_block">
							<div class="sub_block">
								<br>
								<img class="main_content_img"
									src="${cpath}/resources/images/diary.png"><br>아이를 위한
								육아 일기
							</div>
						</div>
						<div class="main_block">
							<div class="sub_block">
								<br>
								<img class="main_content_img"
									src="${cpath}/resources/images/communication.png"><br>아이를
								위한 소통
							</div>
						</div>
					</div>
